...
#     # Dataset paths
#     BASE_PATH = Path(r"D:\\Project-Vimaan\\Dataset\\e_output\\base_cmds.jsonl")
#     PARROT_PATH = Path(r"D:\\Project-Vimaan\\Dataset\\e_output\\parrot_cmds.jsonl")
#     PEGASUS_PATH = Path(r"D:\\Project-Vimaan\Dataset\\e_output\\pegasus_cmds.jsonl")
#     FLANT5_PATH = Path(r"D:\\Project-Vimaan\Dataset\\e_output\\flant5_cmds.jsonl")
...
#     html_path = Path(r"D:\\Project-Vimaan\\Dataset\\d_evaluation") / "pes_report.html"
...
if __name__ == "__main__":
    # Dataset paths
    BASE_PATH = Path(r"D:\\Project-Vimaan\Dataset\\f_output\\base_cmds.jsonl")
    PARROT_PATH = Path(r"D:\\Project-Vimaan\Dataset\\f_output\\parrot_cmds.jsonl")
    PEGASUS_PATH = Path(r"D:\\Project-Vimaan\Dataset\\f_output\\pegasus_cmds.jsonl")
    FLANT5_PATH = Path(r"D:\\Project-Vimaan\Dataset\\f_output\\flant5_cmds.jsonl")
    ...
    # ------------------------------------------------------------------
    report_dir = Path(r"D:\\Project-Vimaan\\Dataset\\e_evaluation")
