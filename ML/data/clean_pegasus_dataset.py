    ...
    with open(input_file) as f:
        for line in tqdm(f.readlines(), desc="Processing entries"):
            ...
            try:
                ...
                issues_found += 1
                print(
                    f"Skipping malformed or incomplete line {original_count}: {line.strip()} | Error: {e}"
                )
...
if __name__ == "__main__":
    ...
    if latest_input_file:
        ...
        print(
            f"Error: Could not find any version of the Pegasus dataset in '{INPUT_DIR}' to clean."
        )
