...
class ModelEvaluator:
    def __init__(self, model_path=None, device=None):
        ...
        try:
            ...
            print(f"Attempting to load with default tokenizer...")
            ...
            try:
                ...
                print(f"Model loaded (with default tokenizer)")
                from transformers import DistilBertTokenizerFast
                self.loader.tokenizer = DistilBertTokenizerFast.from_pretrained('distilbert-base-uncased')
                print(f"Default tokenizer loaded")
    ...
    def print_metrics_summary(self, metrics):
        ...
        print(f"  Correct:            {stats['correct_predictions']} ({stats['correct_predictions']/stats['total_examples']:.1%})")
        print(f"  Incorrect:          {stats['incorrect_predictions']} ({stats['incorrect_predictions']/stats['total_examples']:.1%})")
        ...
        for intent, scores in sorted_intents:
            print(f"\n  {intent}")
            print(f"    Precision: {scores['precision']:.2%} | Recall: {scores['recall']:.2%} | F1: {scores['f1']:.4f}")
